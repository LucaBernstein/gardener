...
| `Gardenlet`                 | `get`, `list`, `watch`, `update`, `patch`                       | `Gardenlet` -> `Seed`                                                                                                         | Allow `get`, `list`, `watch` requests for all `Gardenlet`s. Allow only `update`, `patch` requests for `Gardenlet`s belonging to the `gardenlet`'s `Seed`.                                                                                                                        |
